...
<div class="as-form-wrap">
    ...
    if(in_array('location',$theme_search_fields)){
        ?><div class="field">
          <input type="text" name="location" id="select-location" class="" value="" placeholder="City"/></div>
        <?php
    }?>
    ...
    if(in_array('min-beds',$theme_search_fields)){
        ?>
        <div class="option-bar small">
            <label for="select-bedrooms"><?php _e('Minimum Beds', 'framework'); ?></label>
            <span class="selectwrap">
    ...
    if(in_array('min-baths',$theme_search_fields)){
        ?>
        <div class="option-bar small">
            <label for="select-bathrooms"><?php _e('Minimum Baths', 'framework'); ?></label>
            <span class="selectwrap">
    ...
    if(in_array('min-max-price',$theme_search_fields)){
        ...
        <div class="option-bar small price-for-others">
            <label for="select-min-price"><?php _e('Minimum Price', 'framework'); ?></label>
            <span class="selectwrap">
        ...
        <div class="option-bar small price-for-others">
            <label for="select-max-price"><?php _e('Maximum Price', 'framework'); ?></label>
            <span class="selectwrap">

        ...
        <header id="header" class="clearfix">
            ...
            <div id="header-top" class="clearfix">
                ...
                if (!empty($header_email)) {
                    ?>
                    <h2 id="contact-email">
                        <i class="email"></i> <?php _e('Email us at', 'framework'); ?> : <a
                            href="mailto:<?php echo antispambot($header_email); ?>"><?php echo antispambot($header_email); ?></a>
                    </h2>
                <?php
                }
                ?>
                    ...
                    <div class="user-nav clearfix">
                        ...
                        if (is_user_logged_in()) {
                            ...
                            if (!empty($favorites_url)) {
                                ?><a href="<?php echo $favorites_url; ?>"><i
                                    class="fa fa-star"></i><?php _e('Favorites', 'framework'); ?></a><?php
                            }

                            if (!empty($submit_url)) {
                                ?><a href="<?php echo $submit_url; ?>"><i
                                    class="fa fa-plus-circle"></i><?php _e('Submit', 'framework'); ?></a><?php
                            }

                            if (!empty($my_properties_url)) {
                                ?><a href="<?php echo $my_properties_url; ?>"><i
                                    class="fa fa-th-list"></i><?php _e('My Properties', 'framework'); ?></a><?php
                            }
                            ?>
                            <a href="<?php echo network_admin_url('profile.php'); ?>"><i
                                    class="fa fa-user"></i><?php _e('Profile', 'framework'); ?></a>
                            <a class="last" href="<?php echo wp_logout_url(home_url()); ?>"><i
                                    class="fa fa-sign-out"></i><?php _e('Logout', 'framework'); ?></a>
                        <?php
                            ...
                            if (!empty($theme_login_url)) {
                                ?>
                                <a class="last" href="<?php echo $theme_login_url; ?>"><i
                                        class="fa fa-sign-in"></i><?php _e('Login / Register', 'framework'); ?></a>
                            <?php
                            } else {
                                ?>
            ...
            <div class="pull-right head-link">
                <a href="<?php echo home_url(); ?>contact-us/" class="btn btn-grey">Send Your Enquiry</a>
                <a href="<?php echo home_url(); ?>submit-property/" class="btn btn-grey">List Your Properties</a>
            </div>
            <div class="p-t-20">
                <!-- Logo -->
                <div id="logo">

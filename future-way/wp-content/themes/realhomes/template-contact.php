                                ...
                                <section class="contact-details clearfix">
                                    ...
                                    <ul class="contacts-list">
                                        ...
                                        if(!empty($contact_phone)){
                                            ...
                                            ?><li class="phone"> <?php _e('Phone', 'framework'); ?>: <?php echo $desktop_version . $mobile_version; ?></li><?php
                                        }
                                        if(!empty($contact_cell)){
                                            ...
                                            ?><li class="mobile"> <?php _e('Mobile', 'framework'); ?>: <?php echo $desktop_version . $mobile_version; ?></li><?php
                                        }
                                        if(!empty($contact_fax)){
                                            ?><li class="fax"> <?php _e('Fax', 'framework'); ?>: <?php echo $contact_fax; ?></li><?php
                                        }
                                        if(!empty($contact_display_email)){
                                            ?><li class="email"> <?php _e('Email', 'framework'); ?>: <a href="mailto:<?php echo antispambot($contact_display_email); ?>"><?php echo antispambot($contact_display_email); ?></a></li><?php
                                        }
                                        ?>
                                    </ul>
                                </section>

...
if (!empty($_POST)){
	...
	if(/*!empty($image_name) ||*/ !empty($text)){
		...
		if($result == ''){
			...
			$up_url = 'images/listing.jpg';*/
			$query = mysql_query("UPDATE listing SET description = '$text' WHERE id = '$dbid'")or die(mysql_error());
...
<table>
	...
	<?php
$query = mysql_query("SELECT * FROM listing");
...
?>
	...
	<form class="edit-form" action = "listing.php" method="post" enctype="multipart/form-data">
		<fieldset>
			<div class="row">

...
<div id="main">
	<div id="sidebar">
		<div class="fixed">
			<ul>
				...
				<li class="release"><a href=""></a></li>
				<li class="games"><a href=""></a></li>
				<li class="history"><a href=""></a></li>
				<li class="settings"><a href=""></a></li>
				<li class="out"><a href=""></a></li>
			</ul>
		</div>
	</div>
	...
	<div id="content">
		<div class="page-head">
			<span class="page-heading">players</span>
		...
		<div class="info-wrapper">
			<div class="block">
				...
				<div class="text-area">
					...
					<div class="game-area">
						<span class="value">games installed<span>13</span></span>
						<span class="value">Total hours played<span>543</span></span>
					</div>
				</div>
			</div>
			<div class="block">

	  ...
	  <section class="what-do" id="about">
			...
			<div class="holder">
				  <div class="block visible-lg">
						<div class="col-lg-5 col-xs-12  col-lg-offset-1 text-area">
						...
						<div class="block">
							  ...
							  <div class="col-xs-12 col-lg-6 text-area">
									...
									<div class="buttons-area"><span class="btn"><a href="crew.php"
										  ...
										  <span class="btn"><a href="#" data-text="Find Crew">Find Crew</a></span></div>
							  </div>
						</div>
						<div class="block">
							  <div class="col-xs-12 col-lg-6 text-area one">
									...
									<div class="buttons-area"><span class="btn"><a href="candidates.php"
																				   data-text="Learn More">LEARN MORE</a></span>
										  <span class="btn"><a href="#" data-text="Submit CV">SUBMIT CV</a></span>
									</div>
						...
						<div class="block">
							  ...
							  <div class="col-xs-12 col-lg-6 text-area">
									...
									<div class="buttons-area"><span class="btn"><a href="advice.php"
																				   data-text="Learn More">LEARN MORE</a></span>
										  <span class="btn"><a href="#" data-text="Enquire Now">ENQUIRE NOW</a></span>
									</div>
							  </div>
						</div>
						<div class="block">

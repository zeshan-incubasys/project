				  ...
				  <div class="col-md-7 col-sm-offset-5">
						<div class="row">
							  ...
							  <ul>
									...
									<li>As Captains, we have overcome challenges of building strong teams</li>
									<li>Our hands-on approach in placement which never falters in favor of quantity over quality</li>
									<li>Our filtering process ensures you only shortlist from well-screened candidates</li>
									<li>Our strong network of suppliers and contacts can benefit clients in other marine related areas.</li>
							  </ul>
							  <p>MARINA RECREWTER can be your initiating link in regards to assisting with required management tasks such as - DPA duties, pre-auditing, ISM/ISPS, safety rules and regulation, crew training, maintenance and repair, classification, flag state, sea-trials &amp; delivery crew.</p>
							<h3>Communication Strategy</h3>
							  <ul>
									<li>It’s simple! At MARINA RECREWTER, phone calls and mails never go unaddressed. With contacts worldwide – we are available to meet your needs 24/7.</li>
							  </ul>
							  <h3>A Message from the Director</h3>

							<p>MARINA RECREWTER was founded with the outlook to fulfill a gap in the region, keeping the focus on the ever increasing worldwide demand for certified and experienced crew in the yachting industry as well as commercial shipping. We are focused on quality and long term relationships. Our mission is to be your best source of professional crew and we aim to ensure they are the best in their area of expertise!</p>

							  <div class="pull-right author">
									<h2>Capt. Thomas C Pedersen</h2>
									<strong class="title">Master Mariner and Director MARINA RECREWTER</strong>
							  </div>
						</div>
				  </div>
			</div>

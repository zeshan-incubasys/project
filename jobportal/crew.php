<?php  include('include/header.php');?>
	...
	<div class="crew container">
		<div class="text-area col-md-7">
			...
			<p>Our highly qualified maritime consultants will provide you with a shortlist of qualified Candidates, matching your specific job vacancies and securing you the best available certified and professional crew.</p>
		</div>
	...
	<div class="image-section container crew">
		...
		<ul>
			...
			<li>We have a vast network with access to crewmembers of all nationalities, supporting your preferences for various positions; Senior/Junior Officers and Ratings.</li>

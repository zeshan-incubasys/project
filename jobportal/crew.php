<?php include('include/header.php'); ?>
	  ...
	  <div class="crew container">
			<div class="text-area col-md-7">
				  ...
				  <p>Our efficient maritime consultants will provide you with a shortlist of qualified Candidates, matching your specific job vacancies and securing you the best available, certified and professional crew.</p>
			</div>
			<div class="col-md-5 listing">
				  ...
				  <ul>
						<li>Captains</li>
						<li>Yacht Owners</li>
						<li>Crew &amp; Marine Management companies</li>
				  </ul>
			</div>
	  </div>
	  <div class="image-section container crew">
			<div class="holder">
				  ...
				  <div class="more-area">
						...
						<p>Trying to understand crew dynamics of any given ship, first have a closer look into at the team on board. Nationality and language are important factors, but essentially it is down to personality, qualifications, experience and skills. Professional crewmembers realize the need for training in order to succeed and that a safe environment is essential in order to feel secure and comfortable on board any vessel.</p>
						<a href="#">Read More</a>
				  </div>
			</div>
			<ul>
				  ...
				  <li>We have a vast network with access to crew members of all nationalities, supporting your preferences for various positions - Senior/Junior Officers and Ratings.</li>

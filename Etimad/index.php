<?php include('include/header.php'); ?>
	  ...
	  <div class="content-holder active">
			...
			<div class="text-wrap">
				  ...
				  <p>Etimad deploys the right applied skills for your project through our operational companies</p>
				  <ul>
						<li><a href="javascript:void(0);">Al Fahad Smart Systems, Specializing in …..</a></li>
	  ...
	  <div class="content-holder">
			...
			<div class="text-wrap">
				  <div class="head">
						...
						<span class="subheading">Ensure that the right process is in the right department and under the right skill</span>
				  </div>
				  <p>We deploy the processes and technologies to review and monitoring of execution processes of and across</p>
				  <ul>
	  ...
	  <div class="content-holder">
			...
			<div class="text-wrap">
				  <div class="head">
						...
						<span class="subheading">Tailored project KPIs for measuring project performance</span>
				  </div>
				  <p>We execute continuous review and monitoring of the performance against the agreed KPIs for:</p>
				  <ul>
						<li><a href="javascript:void(0);">Supplier</a></li>
						<li><a href="javascript:void(0);">Financial</a></li>
						<li><a href="javascript:void(0);">Operations</a></li>
	  ...
	  <div class="content-holder">
			...
			<div class="text-wrap">
				  ...
				  <p>Appointing the appropriate and certified qualification for each phase of the project within the foundations of:</p>
				  <ul>
